--- Filter Title: WolfieeifloW's Filter v1.45
...
return {
    reload = "WolfieeifloW's Filter v1.45: {green}reloaded",
    allowOverrides = true,
    -- debug = true,
    rules = {
        -- +-------------------------+
        ...
        -- | SET ITEMS               |
        -- +-------------------------+
        { -- Rule 88: Notify and small border for all Set items
            codes = "allitems",
            quality = "5",
            notify = "{green}Set Drop {link}",
            border = { 0, 206, 0, 255, 1 },
        },
        { -- Rule 89: Civerb's Vestments Set items
            codes = "allitems",
            quality = "5",
            index = { 0, 1, 2 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 90: Hsarus' Defense Set items
            codes = "allitems",
            quality = "5",
            index = { 3, 4, 5 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 91: Cleglaw's Brace Set items
            codes = "allitems",
            quality = "5",
            index = { 6, 7, 8 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 92: Iratha's Finery Set items
            codes = "allitems",
            quality = "5",
            index = { 9, 10, 11, 12 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 93: Isenhart's Armory Set items
            codes = "allitems",
            quality = "5",
            index = { 13, 14, 15, 16 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 94: Vidala's Rig Set items
            codes = "allitems",
            quality = "5",
            index = { 17, 18, 19, 20 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 95: Milabrega's Regalia Set items
            codes = "allitems",
            quality = "5",
            index = { 21, 22, 23, 24 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 96: Cathan's Traps Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 97: Tancred's Battlegear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 98: Sigon's Complete Steel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 99: Infernal Tools Set items
            codes = "allitems",
            quality = "5",
            index = { 41, 42, 43 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 100: Berserker's Arsenal Set items
            codes = "allitems",
            quality = "5",
            index = { 44, 45, 46 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 101: Death's Disguise Set items
            codes = "allitems",
            quality = "5",
            index = { 47, 48, 49 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 102: Angelic Raiment Set items
            codes = "allitems",
            quality = "5",
            index = { 50, 51, 52, 53 },
            location = { "onplayer", "atvendor" },
        ...
        -- },
        { -- Rule 103: Arcanna's Tricks Set items
            codes = "allitems",
            quality = "5",
            index = { 58, 59, 60, 61 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 104: Natalya's Odium Set items
            codes = "allitems",
            quality = "5",
            index = { 62, 63, 64, 65 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 105: Aldur's Watchtower Set items
            codes = "allitems",
            quality = "5",
            index = { 66, 67, 68, 69 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 106: Immortal King Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 107: Tal Rasha's Wrappings Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 108: Griswold's Legacy Set items
            codes = "allitems",
            quality = "5",
            index = { 81, 82, 83, 84 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 109: Trang-Oul's Avatar Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 110: M'avina's Battle Hymn Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 111: The Disciple Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 112: Heaven's Brethren Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 113: Orphan's Call Set items
            codes = "allitems",
            quality = "5",
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 114: Sazabi's Grand Tribute Set items
            codes = "allitems",
            quality = "5",
            index = { 112, 113, 114 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 115: Bul-Kathos' Children Set items
            codes = "allitems",
            quality = "5",
            index = { 115, 116 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 116: Cow King's Leathers Set items
            codes = "allitems",
            quality = "5",
            index = { 117, 118, 119 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 117: Naj's Ancient Vestige Set items
            codes = "allitems",
            quality = "5",
            index = { 120, 121, 122 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 118: Holy Vessel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 119: Majestic Lancer Set items
            codes = "allitems",
            quality = "5",
            index = { 131, 132, 133 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 120: Wonder Wear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 121: Vizjerei Vocation Set items
            codes = "allitems",
            quality = "5",
            index = { 141, 142, 143 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 122: Beyond Battlemage Set items
            codes = "allitems",
            quality = "5",
            index = { 144, 145, 146 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 123: Glacial Plains Set items
            codes = "allitems",
            quality = "5",
            index = { 147, 148, 149 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 124: Rathma's Calling Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 125: Stacatomamba's Guidance Set items
            codes = "allitems",
            quality = "5",
            index = { 154, 155 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 126: Kreigur's Mastery Set items
            codes = "allitems",
            quality = "5",
            index = { 156, 157 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 127: Mirrored Flames Set items
            codes = "allitems",
            quality = "5",
            index = { 160, 161, 162 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 128: Unstoppable Force Set items
            codes = "allitems",
            quality = "5",
            index = { 163, 164 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 129: Elemental Blueprints Set items
            codes = "allitems",
            quality = "5",
            index = { 168, 169, 170 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 130: Blessings of Artemis Set items
            codes = "allitems",
            quality = "5",
            index = { 179, 180 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 131: Artio's Calling Set items
            codes = "allitems",
            quality = "5",
            index = { 181, 182, 183 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 144: Death's Disguise Forsaken Pact
            code = "L12",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Unstoppable Force {grey}({green}Bul-Kathos' + Berserker's + Death's{grey})\n{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 145: Angelic Raiment Forsaken Pact
            code = "L13",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 146: Arctic Gear Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L14",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 147: Arcanna's Tricks Forsaken Pact
            code = "L15",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Elemental Blueprints {grey}({green}Iratha's + Arcanna's + Naj's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 148: Natalya's Odium Forsaken Pact
            code = "L16",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 149: Aldur's Watchtower Forsaken Pact
            code = "L17",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Warrior's Wrath {grey}({green}Immortal King + Aldur's + Infernal{grey})\n{green}Mirrored Flames {grey}({green}Civerb's + Aldur's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 150: Immortal King Forsaken Pact
            code = "L18",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Blacklight (Paladin) {grey}({green}Sigon's + Immortal King{grey})\n{green}Blacklight (Barbarian) {grey}({green}Sigon's + Immortal King{grey})\n{green}Warrior's Wrath {grey}({green}Immortal King + Aldur's + Infernal{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 151: Tal Rasha's Wrappings Forsaken Pact
            code = "L19",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 152: Griswold's Legacy Forsaken Pact
            code = "L20",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 153: Trang-Oul's Avatar Forsaken Pact
            code = "L21",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Underworld Unrest {grey}({green}Trang-Oul's + Tancred's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 154: M'avina's Battle Hymn Forsaken Pact
            code = "L22",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Blessing of Artemis {grey}({green}Vidala's + M'avina's + Bul-Kathos'{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 155: The Disciple Forsaken Pact
            code = "L23",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Celestial Caress {grey}({green}Angelic + Disciple + Holy Vessel's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 156: Heaven's Brethren Forsaken Pact
            code = "L24",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Raijin's Rebellion {grey}({green}Milabrega's + Cathan's + Heaven's Brethren{grey})\n{green}Pulsing Presence {grey}({green}Sigon's + Angelic + Heaven's Brethren{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 157: Orphan's Call Forsaken Pact
            code = "L25",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Justitia's Divinity {grey}({green}Sigon's + Orphan's Call{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 158: Hwanin's Majesty Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L26",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 159: Sazabi's Grand Tribute Forsaken Pact
            code = "L27",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Plates of Protection {grey}({green}Isenhart's + Sazabi's + Wonder Wear{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 160: Bul-Kathos' Children Forsaken Pact
            code = "L28",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Unstoppable Force {grey}({green}Bul-Kathos' + Berserker's + Death's{grey})\n{green}Blessing of Artemis {grey}({green}Vidala's + M'avina's + Bul-Kathos'{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 161: Cow King's Leathers Forsaken Pact
            code = "L29",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Artio's Calling {grey}({green}Berserker's + Cow King's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 162: Naj's Ancient Vestige Forsaken Pact
            code = "L30",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Elemental Blueprints {grey}({green}Iratha's + Arcanna's + Naj's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 163: Sander's Folly Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L31",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 164: Holy Vessel Forsaken Pact
            code = "L32",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Celestial Caress {grey}({green}Angelic + Disciple + Holy Vessel's{grey})\n{green}Breaker of Chains {grey}({green}Holy Vessel's + Majestic Lancer's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 165: Majestic Lancer Forsaken Pact
            code = "L33",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Breaker of Chains {grey}({green}Holy Vessel's + Majestic Lancer's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 166: Skovos Storm Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L34",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 167: Wonder Wear Forsaken Pact
            code = "L35",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Plates of Protection {grey}({green}Isenhart's + Sazabi's + Wonder Wear{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 168: Vizjerei Vocation Forsaken Pact
            code = "L36",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 169: Beyond Battlemage Forsaken Pact
            code = "L37",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 170: Glacial Plains Forsaken Pact
            code = "L38",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Black Tempest {grey}({green}Glacial Plains + Blessings of Artemis{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 171: Rathma's Calling Forsaken Pact
            code = "L39",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Mikael's Toxicity {grey}({green}Cleglaw's + Rathma's{grey})\n{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 172: Stacatomamba's Guidance Forsaken Pact
            code = "L40",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Mangala's Teachings {grey}({green}Hsarus' + Natalya's + Stacatomamba's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 173: Kreigur's Mastery Forsaken Pact
            code = "L41",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Silhouette of Silence {grey}({green}Natalya's + Kreigur's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 174: Scarlet Sukami Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L42",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 175: Mirrored Flames Forsaken Pact
            code = "L43",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 176: Unstoppable Force Forsaken Pact
            code = "L44",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Path of the Vortex (Barbarian) {grey}({green}Unstoppable Force + Natalya's{grey})\n{green}Path of the Vortex (Assassin) {grey}({green}Unstoppable Force + Natalya's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 177: Underworld's Unrest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L45",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 178: Elemental Blueprints Forsaken Pact
            code = "L46",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 179: Raijin's Rebellion Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L47",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 180: Mikael's Toxicity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L48",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 181: Warrior's Wrath Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L49",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 182: Blessings of Artemis Forsaken Pact
            code = "L50",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Black Tempest {grey}({green}Glacial Plains + Blessings of Artemis{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 183: Artio's Calling Forsaken Pact
            code = "L51",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 184: Justitia's Divinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L52",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 185: Pulsing Presence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L53",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 186: Celestial Caress Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L54",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 187: Breaker of Chains Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L55",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 188: Silhouette of Silence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L56",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 189: Mangala's Teachings Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L57",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 190: Sacrificial Trinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L58",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 191: Plates of Protection Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L59",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 192: Black Tempest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L60",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        ...
        -- | RARE ITEMS              |
        -- +-------------------------+
        { -- Rule 193: Small border on Rare Jewels
            code = "jew",
            quality = "6",
            border = { 255, 255, 100, 255, 1 }
        },
        { -- Rule 194: Hide all non-LB Rare Weapons, Armor, Jewelry, and Quiver items at Character Level 75+ (they are relatively useless)
        ...
        { -- Rule 196: Notify and small border for all Exceptional Unique items
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std", "Ev01", "Ev02" },
            quality = "7",
            rarity = "1",
            notify = "Unique Drop ²{link}",
        ...
        { -- Rule 197: Notify and small border for all Elite Unique items
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std", "Ev01", "Ev02" },
            quality = "7",
            rarity = "2",
            notify = "Unique Drop ³{link}",
        ...
        { -- Rule 198: Correcting Unique Small Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 82,
        ...
        { -- Rule 199: Correcting Unique Medium Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 83,
        ...
        { -- Rule 200: Correcting Unique Grand Carm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 84,
        ...
        { -- Rule 201: Correcting Annihilus name color
            code = "cm1",
            quality = "7",
            index = 543,
            identified = true,
        ...
        { -- Rule 202: Correcting Cola Cube name color
            code = "cm1",
            quality = "7",
            index = 606,
            identified = true,
        ...
        { -- Rule 203: Correcting Gheed's Fortune name color
            code = "cm3",
            quality = "7",
            index = 542,
            identified = true,
        ...
        { -- Rule 204: Correcting Unholy Commander name color
            code = "cm3",
            quality = "7",
            index = 590,
            identified = true,
        ...
        { -- Rule 205: Correcting Kuroneko no Himitsu name color
            code = "cm3",
            quality = "7",
            index = 654,
            identified = true,
        ...
        { -- Rule 206: Correcting Blank Talent name color
            code = "cm3",
            quality = "7",
            index = 611,
            identified = true,
        ...
        -- | CRAFTED ITEMS           |
        -- +-------------------------+
        { -- Rule 207: Reminder to pick up Crafted items so they don't get left behind
            codes = "allitems",
            quality = "8",
        ...
        -- | TEMPERED ITEMS          |
        -- +-------------------------+
        { -- Rule 208: Reminder to pick up Tempered items so they don't get left behind
            codes = "allitems",
            quality = "9",
            notify = "{green}DON'T FORGET ME! {link}"
        },
        { -- Rule 209: Normal Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "0",
        ...
        { -- Rule 210: Exceptional Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "1",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 211: Elite Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "2",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 212: Misc Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            stat = { index = 402, op = "==", value = 0 },
        ...
        {-- Rule 213: Parts for Demon-Tempering
        ...
        -- | POTIONS & SCROLLS       |
        -- +-------------------------+
        { -- Rule 214: Hides all non-large Potions & Scrolls after Normal Difficulty
            codes = { "mp1", "mp2", "mp3", "hp1", "hp2", "hp3", "isc", "tsc", "rvs"},
            difficulty = "1+",
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
            hide = true
        },
        { -- Rule 215: Add helper text to Antidote Potion that it's used in Blood Contracts
            code = "yps",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Used for {green}Set {gray}Blood Contracts\n"
        },
        { -- Rule 216: Add helper text to Thawing Potion that it's used in Blood Contracts
            code = "wms",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Used for {gold}Unique {gray}Blood Contracts\n"
        },
        { -- Rule 217: Add helper text to Scroll of Identify for some cube recipes it's in
            code = "isc",
            location = { "onplayer", "atvendor" },
        ...
        -- | BASE ITEMS              |
        -- +-------------------------+
        { -- Rule 218: Reminder to pick up Runeword items so they don't get left behind
            codes = "allitems",
            runeword = true,
            notify = "{grey}DON'T FORGET ME! {gold}{link}",
            border = { 199, 179, 119, 255, 3 }
        },
        { -- Rule 219: Hiding Inferior items at Character Level 10+
            codes = NOT { "leg" },
            quality = "1",
            itype = { 45, 50 },
            runeword = false,
        ...
        { -- Rule 220: Hiding Normal items at Character Level 50+
            codes = NOT { "leg" },
            quality = "2",
            itype = { 45, 50 },
            runeword = false,
        ...
        { -- Rule 221: Hiding Normal quivers at Character Level 10+
            codes = { "aqv", "cqv" },
            quality = "3-",
            pstat = { index = 12, op = ">=", value = 10 },
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        ...
        { -- Rule 222: Hides all +0 to Paladin Skill Levels Scepters at Character Level 50+
        ...
        -- | ITEM HELPER TEXT        |
        -- +-------------------------+
        { -- Rule 223: Scroll of Inifuss
            code = "bks",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Talk to {white}Akara {grey}in Act 1\n\n"
        },
        { -- Rule 224: Scroll of Inifuss, deciphered
            code = "bkd",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 262: Amethyst Remover
            code = "Z02",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {purple}Caster {grey}crafting\n"
        },
        { -- Rule 263: Topaz Remover
            code = "Z03",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {yellow}Disarm {grey}crafting\n"
        },
        { -- Rule 264: Sapphire Remover
            code = "Z04",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {blue}Hit Power {grey}crafting\n"
        },
        { -- Rule 265: Emerald Remover
            code = "Z05",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {green}Safety {grey}crafting\n"
        },
        { -- Rule 266: Ruby Remover
            code = "Z06",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {red}Blood {grey}crafting\n"
        },
        { -- Rule 267: Diamond Remover
            code = "Z07",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {white}Legion {grey}crafting\n{white}"
        },
        { -- Rule 268: Skull Remover
            code = "Z08",
            location = { "onplayer", "atvendor" },
        },
        { -- Rule 269: Adding Soul Shards helper text
            code = "S01",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{tan}1-3 Soul Shards (used for Soul Summons)\n",
        },
        { -- Rule 270: Normal Unique Armor & Weapon upgrade recipe
        ...
        { -- Rule 271: Normal Rare Armor & Weapon upgrade recipe
            codes = "allitems",
            itype = { 45, 50 },
            quality = "6",
            rarity = "0",
        ...
        { -- Rule 272: Exceptional Unique Armor & Weapon upgrade recipe
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std" },
            itype = { 45, 50 },
            quality = "7",
            rarity = "1",
        ...
        { -- Rule 273: Exceptional Rare Armor & Weapon upgrade recipe
            codes = "allitems",
            itype = { 45, 50 },
            quality = "6",
            rarity = "1",
        ...
        { -- Rule 275: Premium Socket Remover
            code = "b65",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 276: Infinite Socket Remover
            code = "b66",
            location = { "onplayer", "atvendor" },
            name_override = "{gold}Infinite Socket Remover",
        },
        { -- Rule 277: Rainbow Facets
            code = "jew",
            quality = "7",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 278: Color all class tokens
            codes = { "TK1", "TK2", "TK3", "TK4", "TK5", "TK6", "TK7" },
            location = { "onplayer", "atvendor", "onground" },
            prefix = "{purple}",
        },
        { -- Rule 279: Add info to Amazon Class Token
            code = "TK1",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 287: Display cube recipes on Gold Bar that relate to it
            code = "Y21",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 288: On Ramaladni's Gift display the limits it has on Weapons
            code = "Rgx",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 289: Helper text for 0 socket items to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = "8-",
            maxsock = false,
            itype = { 10, 12, 50 },
        ...
        { -- Rule 290: Helper text for Magic/Rare/Crafted 0 socket Weapons to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = { "4", "6", "8" },
            maxsock = false,
            itype = 45,
        ...
        { -- Rule 291: Helper text for Set/Unique 1-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 292: Helper text for Set/Unique 2-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 293: Shows maximum sockets a non-Weapon item can get
        ...
        { -- Rule 294: Shows maximum sockets an Inferior/Normal/Magic/Rare/Crafted Weapon can get
            codes = "allitems",
            quality = { "1", "2", "3", "4", "6", "8" },
            itype = 45,
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 295: Add helper text for Set/Unique Weapons that have a maximum of 2, 3, & 4 sockets
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2" },
            quality = { "5", "7" },
            maxsock = "4-",
            itype = 45,
        ...
        { -- Rule 296: Add helper text for 1-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
        ...
        { -- Rule 297: Add helper text for 2-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
            codes = { "lax", "bax", "btx", "gax", "gix", "mau", "gma", "clm", "gis", "bsw", "flb", "gsd", "spr", "tri", "brn", "spt", "pik", "bar", "vou", "scy", "pax", "hal", "wsc", "sst", "lst", "cst", "bst", "wst", "sbw", "hbw", "lbw", "cbw", "sbb", "lbb", "swb", "lwb", "lxb", "mxb", "hxb", "rxb", "9la", "9ba", "9bt", "9ga", "9gi", "9m9", "9gm", "9cm", "9gs", "9b9", "9fb", "9gd", "9sr", "9tr", "9br", "9st", "9p9", "9b7", "9vo", "9s8", "9pa", "9h9", "9wc", "8ss", "8ls", "8cs", "8bs", "8ws", "8sb", "8hb", "8lb", "8cb", "8s8", "8l8", "8sw", "8lw", "8lx", "8mx", "8hx", "8rx", "7la", "7ba", "7bt", "7ga", "7gi", "7m7", "7gm", "7cm", "7gs", "7b7", "7fb", "7gd", "7sr", "7tr", "7br", "7st", "7p7", "7o7", "7vo", "7s8", "7pa", "7h7", "7wc", "6ss", "6ls", "6cs", "6bs", "6ws", "6sb", "6hb", "6lb", "6cb", "6s7", "6l7", "6sw", "6lw", "6lx", "6mx", "6hx", "6rx", "am1", "am2", "am3", "am4", "am6", "am7", "am8", "am9", "amb", "amc", "amd", "ame", "Ds1", "Ds2", "Ds3", "Ds4", "Ds5", "Ds6", "Bm1", "Bm2", "Bm3", "Bm4", "Bm5", "Bm6", "Bm7", "Bm8", "Bm9", "l14", "l15", "l17", "l18" },
            quality = { "5", "7" },
            maxsock = "5+",
            itype = 45,
        ...
        { -- Rule 298: Special use-case for Rune Master (since it can get 5 sockets)
            code = "72a",
            quality = "7",
            index = 189,
            sockets = "4-",
        ...
        { -- Rule 299: Special use-case for Rune Master (since it can get 5 sockets)
            code = "72a",
            quality = "7",
            index = 189,
            sockets = "5",
        ...
        -- | TAGS & GENERIC RULES    |
        -- +-------------------------+
        { -- Rule 300: Adding item level to non-Ethereal non-socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
        ...
        { -- Rule 301: Adding item level to Ethereal items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = true,
            location = { "onplayer", "equipped" , "onground", "dropping", "atvendor" },
        ...
        { -- Rule 302: Adding item level to Non-Ethereal socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = false,
            sockets = "1+",
        ...
        { -- Rule 303: Color item name and add [Eth] tag to Inferior, Normal, and Superior items
            codes = "allitems",
            quality = "3-",
            ethereal = true,
            prefix = "ÿcI",
        ...
        { -- Rule 304: Do NOT color item name but still add [Eth] tag to Magic+ items
            codes = "allitems",
            quality = "4+",
            ethereal = true,
            suffix = "{grey}[Eth]"
        },
        { -- Rule 305: Adding socket number tag to 1 socket items
            codes = "allitems",
            sockets = "1",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 306: Adding socket number tag to 2 socket non-max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "3+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 307: Adding socket number tag to 2 socket max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "2",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 308: Adding socket number tag to 3 socket non-max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "4+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 309: Adding socket number tag to 3 socket max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "3",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 310: Adding socket number tag to 4 socket non-max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "5+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 311: Adding socket number tag to 4 socket max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "4",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 312: Adding socket number tag to 5 socket non-max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "6+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 313: Adding socket number tag to 5 socket max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "5",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 314: Adding socket number tag to 6 socket non-max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "7+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 315: Adding socket number tag to 6 socket max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "6",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 316: Adding socket number tag to 7 socket non-max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "8+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 317: Adding socket number tag to 7 socket max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "7",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 318: Adding socket number tag to 8 socket non-max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "9+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 319: Adding socket number tag to 8 socket max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "8",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 320: Adding socket number tag to 9 socket non-max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "10+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 321: Adding socket number tag to 9 socket max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "9",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 322: Adding superscript "1" in front of Normal tier items names
            codes = "allitems",
            rarity = "0",
            itype = { 45, 50 },
        ...
        { -- Rule 323: Adding superscript "2" in front of Exceptional tier items names
            codes = "allitems",
            rarity = "1",
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 324: Adding superscript "EB 3" in front of Elite tier items names
            codes = NOT { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 325: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior Ethereal Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = true,
            rarity = "2",
            quality = "3-",
        ...
        { -- Rule 326: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = false,
            sockets = "1+",
            rarity = "2",
        ...
        { -- Rule 327: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal non-socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = false,
            sockets = "0",
            rarity = "2",
        ...
        { -- Rule 328: Adding colored superscript "LB 3" in front of Elite tier Magic Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "4",
            itype = { 45, 50 },
        ...
        { -- Rule 329: Adding colored superscript "LB 3" in front of Elite tier Set Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "5",
            itype = { 45, 50 },
        ...
        { -- Rule 330: Adding colored superscript "LB 3" in front of Elite tier Rare Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "6",
            itype = { 45, 50 },
        ...
        { -- Rule 331: Adding colored superscript "LB 3" in front of Elite tier Unique Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "7",
            itype = { 45, 50 },
        ...
        { -- Rule 332: Adding colored superscript "LB 3" in front of Elite tier Crafted Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "8",
            itype = { 45, 50 },
        ...
        { -- Rule 333: Adding colored superscript "LB 3" in front of Elite tier Demon Tempered Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "9",
            itype = { 45, 50 },
        ...
        { -- Rule 334: Notify for Elite tier Limit Break items
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            itype = { 45, 50 },
        ...
        -- | TESTING                 |
        -- +-------------------------+
        -- { -- Rule 335: For testing, adds a bunch of info to item
        --     codes = "allitems",
        --     location = { "onplayer", "equipped", "onground", "dropping", "atvendor" },
