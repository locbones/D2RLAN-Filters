--- Filter Title: WolfieeifloW's Filter v1.47
...
return {
    reload = "WolfieeifloW's Filter v1.47: {green}reloaded",
    allowOverrides = true,
    -- debug = true,
    rules = {
        -- +-------------------------+
        ...
        { -- Rule 18: Notify and medium border for all Blood Contracts
            codes = { "a00", "A00", "a01", "A01", "a02", "A02", "a03", "A03", "a04", "A04", "a05", "A05", "A06", "a07", "A07", "a08", "A08", "a09", "A09", "A10", "A11", "A12", "A13", "A14", "A15", "A16", "A17", "A18", "A19", "A20", "A21", "A22", "A23", "A24", "A25", "A26", "A27", "A28", "A29", "A30", "A31", "A32", "A33", "A34", "A35", "A36", "A37", "A38", "A39", "A40", "A41", "A42", "A43", "A44", "A45", "A46", "A47", "A48", "A49", "A50", "A51", "A52", "A53", "A54", "A55", "A56", "A57", "A58", "A59", "A60", "A61", "A62", "A63", "A64", "A65", "A66", "a67", "A67", "a68", "A68", "a69", "A69", "a70", "A70", "a71", "A71", "a72", "A72", "a73", "A73", "a74", "A74", "a75", "A75", "a76", "A76", "a77", "A77", "a78", "A78", "a79", "A79", "a80", "A80", "a81", "A81", "a82", "A82", "a83", "A83", "a84", "A84", "a85", "A85", "a86", "A86", "a87", "A87", "a88", "A88", "a89", "A89", "a90", "A90", "a91", "A91", "a92", "A92", "a93", "A93", "a94", "A94", "a95", "A95", "a96", "A96", "a97", "A97", "a98", "A98", "a99", "A99", "b00", "b01", "b02", "b03", "b04", "b05", "b06", "b07", "b08", "b09", "b10", "b11", "b12", "b13", "b14", "b15", "b16", "b17", "b18", "b19", "b20", "b21", "b22", "b23", "b24", "b25", "b26", "b27", "b28", "b29", "b30", "b31", "b32", "b33", "b34", "b35", "b36", "b37", "b38", "b39", "b40", "b41", "b42", "b43", "b44", "b45", "b46", "b47", "b48", "b49", "b50", "b51", "b52", "b53", "b54", "b55", "b56", "b57", "b58", "b59", "b60", "b61", "b62", "b63" },
            name_override = "{orange}Blood Contract"
        },
        { -- Rule 19: On ground add what type of Blood Contract this is (Unique Weapon)
            code = "a00",
            name_override = "{gold}Unique Weapon\n{orange}Blood Contract"
        },
        { -- Rule 20: On ground add what type of Blood Contract this is (Unique Armor)
            code = "a01",
            name_override = "{gold}Unique Armor\n{orange}Blood Contract"
        },
        { -- Rule 21: On ground add what type of Blood Contract this is (Unique Jewelry)
            code = "a02",
            name_override = "{gold}Unique Jewelry\n{orange}Blood Contract"
        },
        { -- Rule 22: On ground add what type of Blood Contract this is (Set Weapon)
            code = "a03",
            name_override = "{green}Set Weapon\n{orange}Blood Contract"
        },
        { -- Rule 23: On ground add what type of Blood Contract this is (Set Armor)
            code = "a04",
            name_override = "{green}Set Armor\n{orange}Blood Contract"
        },
        { -- Rule 24: On ground add what type of Blood Contract this is (Set Jewelry)
            code = "a05",
            name_override = "{green}Set Jewelry\n{orange}Blood Contract"
        },
        { -- Rule 25: Random RMD items that have gold names (used to match chat color brackets for notify)
        ...
        { -- Rule 26: Random RMD items that have red names (used to match chat color brackets for notify)
            codes = { "hpf", "hpo", "rpl", "rps", "y67" },
            notify = "{purple}RMD Item {red}{link}",
            border = { 174, 0, 255, 255, 3 }
        },
        { -- Rule 27: Random RMD items that have blue names (used to match chat color brackets for notify)
        ...
        { -- Rule 28: Random RMD items that have white names (used to match chat color brackets for notify)
        ...
        { -- Rule 29: Random RMD items that have pink names (used to match chat color brackets for notify)
            codes = { "y33" },
            notify = "{purple}RMD Item {pink}{link}",
            border = { 174, 0, 255, 255, 3 }
        },
        { -- Rule 30: Random RMD items that I'm unsure what color their name is (recoloring them white for now)
        ...
        { -- Rule 33: Add helper text to Key of Terror Remover to show where the key drops
            code = "Z42",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Key of Terror {grey}drops from Hell The Countess (Act 1: Forgotten Tower)\n"
        },
        { -- Rule 34: Add helper text to Key of Hate Remover to show where the key drops
            code = "Z43",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Key of Hate {grey}drops from Hell The Summoner (Act 2: Arcane Sanctuary)\n"
        },
        { -- Rule 35: Add helper text to Key of Destruction Remover to show where the key drops
            code = "Z44",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Key of Destruction {grey}drops from Hell Nihlathak (Act 5: Halls of Vaught)\n"
        },
        { -- Rule 36: Add helper text to Diablo's Horn Remover to show where the key drops
            code = "Z45",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Diablo's Horn {grey}drops from Lilth (Matron's Den)\n"
        },
        { -- Rule 37: Add helper text to Baal's Eye Remover to show where the key drops
            code = "Z46",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Baal's Eye {grey}drops from Über Izual (Furnace of Pain)\n"
        },
        { -- Rule 38: Add helper text to Mephisto's Brain Remover to show where the key drops
            code = "Z47",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{orange}Mephisto's Brain {grey}drops from Über Duriel (Forgotten Sands)\n"
        },
        { -- Rule 39: UpConverter's are only for Rare and Unique items
            codes = { "u01", "u02" },
            location = { "onplayer", "atvendor" },
        ...
        -- | QUEST ITEMS             |
        -- +-------------------------+
        { -- Rule 40: Notify and medium border all quest items
        ...
        -- | ESSENCES & TOKEN        |
        -- +-------------------------+
        { -- Rule 41: Notify and small border on essences and tokens
        ...
        -- | UBER ITEMS              |
        -- +-------------------------+
        { -- Rule 42: Notify and small border on Über items
            codes = { "pk1", "pk2", "pk3", "mbr", "dhn", "bey" },
            notify = "{orange}Übers Item {link}",
            border = { 255, 168, 0, 255, 1 }
        },
        { -- Rule 43: Notify and small border on Standard of Heroes
            code = "std",
        ...
        -- | MAGIC ITEMS             |
        -- +-------------------------+
        { -- Rule 85: Hide all non-LB Magic Weapon and Armor items at Character Level 75+ (non-LB Magic items can be gambled for crafting)
        ...
        { -- Rule 86: Hide all magic Amulets, Rings, & Quivers at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        -- | SET ITEMS               |
        -- +-------------------------+
        { -- Rule 88: Notify and small border for all Normal Set items
            codes = "allitems",
            quality = "5",
            rarity = "0",
        ...
        { -- Rule 89: Notify and small border for all Exceptional Set items
            codes = "allitems",
            quality = "5",
            rarity = "1",
            notify = "{green}Set Drop ²{link}",
        ...
        { -- Rule 90: Notify and small border for all Elite Set items
            codes = "allitems",
            quality = "5",
            rarity = "2",
            notify = "{green}Set Drop ³{link}",
        ...
        { -- Rule 91: Civerb's Vestments Set items
            codes = "allitems",
            quality = "5",
            index = { 0, 1, 2 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 92: Hsarus' Defense Set items
            codes = "allitems",
            quality = "5",
            index = { 3, 4, 5 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 93: Cleglaw's Brace Set items
            codes = "allitems",
            quality = "5",
            index = { 6, 7, 8 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 94: Iratha's Finery Set items
            codes = "allitems",
            quality = "5",
            index = { 9, 10, 11, 12 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 95: Isenhart's Armory Set items
            codes = "allitems",
            quality = "5",
            index = { 13, 14, 15, 16 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 96: Vidala's Rig Set items
            codes = "allitems",
            quality = "5",
            index = { 17, 18, 19, 20 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 97: Milabrega's Regalia Set items
            codes = "allitems",
            quality = "5",
            index = { 21, 22, 23, 24 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 98: Cathan's Traps Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 99: Tancred's Battlegear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 100: Sigon's Complete Steel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 101: Infernal Tools Set items
            codes = "allitems",
            quality = "5",
            index = { 41, 42, 43 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 102: Berserker's Arsenal Set items
            codes = "allitems",
            quality = "5",
            index = { 44, 45, 46 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 103: Death's Disguise Set items
            codes = "allitems",
            quality = "5",
            index = { 47, 48, 49 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 104: Angelic Raiment Set items
            codes = "allitems",
            quality = "5",
            index = { 50, 51, 52, 53 },
            location = { "onplayer", "atvendor" },
        ...
        -- },
        { -- Rule 105: Arcanna's Tricks Set items
            codes = "allitems",
            quality = "5",
            index = { 58, 59, 60, 61 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 106: Natalya's Odium Set items
            codes = "allitems",
            quality = "5",
            index = { 62, 63, 64, 65 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 107: Aldur's Watchtower Set items
            codes = "allitems",
            quality = "5",
            index = { 66, 67, 68, 69 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 108: Immortal King Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 109: Tal Rasha's Wrappings Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 110: Griswold's Legacy Set items
            codes = "allitems",
            quality = "5",
            index = { 81, 82, 83, 84 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 111: Trang-Oul's Avatar Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 112: M'avina's Battle Hymn Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 113: The Disciple Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 114: Heaven's Brethren Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 115: Orphan's Call Set items
            codes = "allitems",
            quality = "5",
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 116: Sazabi's Grand Tribute Set items
            codes = "allitems",
            quality = "5",
            index = { 112, 113, 114 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 117: Bul-Kathos' Children Set items
            codes = "allitems",
            quality = "5",
            index = { 115, 116 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 118: Cow King's Leathers Set items
            codes = "allitems",
            quality = "5",
            index = { 117, 118, 119 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 119: Naj's Ancient Vestige Set items
            codes = "allitems",
            quality = "5",
            index = { 120, 121, 122 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 120: Holy Vessel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 121: Majestic Lancer Set items
            codes = "allitems",
            quality = "5",
            index = { 131, 132, 133 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 122: Wonder Wear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 123: Vizjerei Vocation Set items
            codes = "allitems",
            quality = "5",
            index = { 141, 142, 143 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 124: Beyond Battlemage Set items
            codes = "allitems",
            quality = "5",
            index = { 144, 145, 146 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 125: Glacial Plains Set items
            codes = "allitems",
            quality = "5",
            index = { 147, 148, 149 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 126: Rathma's Calling Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 127: Stacatomamba's Guidance Set items
            codes = "allitems",
            quality = "5",
            index = { 154, 155 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 128: Kreigur's Mastery Set items
            codes = "allitems",
            quality = "5",
            index = { 156, 157 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 129: Mirrored Flames Set items
            codes = "allitems",
            quality = "5",
            index = { 160, 161, 162 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 130: Unstoppable Force Set items
            codes = "allitems",
            quality = "5",
            index = { 163, 164 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 131: Elemental Blueprints Set items
            codes = "allitems",
            quality = "5",
            index = { 168, 169, 170 },
            location = { "onplayer", "atvendor" },
        ...
        --     prefix_desc = "{green}xx\n{grey}Used in {green}Forsaken Pacts{grey}:\n"
        -- },
        { -- Rule 132: Blessings of Artemis Set items
            codes = "allitems",
            quality = "5",
            index = { 179, 180 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 133: Artio's Calling Set items
            codes = "allitems",
            quality = "5",
            index = { 181, 182, 183 },
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 146: Death's Disguise Forsaken Pact
            code = "L12",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Unstoppable Force {grey}({green}Bul-Kathos' + Berserker's + Death's{grey})\n{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 147: Angelic Raiment Forsaken Pact
            code = "L13",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 148: Arctic Gear Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L14",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 149: Arcanna's Tricks Forsaken Pact
            code = "L15",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Elemental Blueprints {grey}({green}Iratha's + Arcanna's + Naj's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 150: Natalya's Odium Forsaken Pact
            code = "L16",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 151: Aldur's Watchtower Forsaken Pact
            code = "L17",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Warrior's Wrath {grey}({green}Immortal King + Aldur's + Infernal{grey})\n{green}Mirrored Flames {grey}({green}Civerb's + Aldur's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 152: Immortal King Forsaken Pact
            code = "L18",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Blacklight (Paladin) {grey}({green}Sigon's + Immortal King{grey})\n{green}Blacklight (Barbarian) {grey}({green}Sigon's + Immortal King{grey})\n{green}Warrior's Wrath {grey}({green}Immortal King + Aldur's + Infernal{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 153: Tal Rasha's Wrappings Forsaken Pact
            code = "L19",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 154: Griswold's Legacy Forsaken Pact
            code = "L20",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 155: Trang-Oul's Avatar Forsaken Pact
            code = "L21",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Underworld Unrest {grey}({green}Trang-Oul's + Tancred's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 156: M'avina's Battle Hymn Forsaken Pact
            code = "L22",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Blessing of Artemis {grey}({green}Vidala's + M'avina's + Bul-Kathos'{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 157: The Disciple Forsaken Pact
            code = "L23",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Celestial Caress {grey}({green}Angelic + Disciple + Holy Vessel's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 158: Heaven's Brethren Forsaken Pact
            code = "L24",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Raijin's Rebellion {grey}({green}Milabrega's + Cathan's + Heaven's Brethren{grey})\n{green}Pulsing Presence {grey}({green}Sigon's + Angelic + Heaven's Brethren{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 159: Orphan's Call Forsaken Pact
            code = "L25",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Justitia's Divinity {grey}({green}Sigon's + Orphan's Call{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 160: Hwanin's Majesty Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L26",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 161: Sazabi's Grand Tribute Forsaken Pact
            code = "L27",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Plates of Protection {grey}({green}Isenhart's + Sazabi's + Wonder Wear{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 162: Bul-Kathos' Children Forsaken Pact
            code = "L28",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Unstoppable Force {grey}({green}Bul-Kathos' + Berserker's + Death's{grey})\n{green}Blessing of Artemis {grey}({green}Vidala's + M'avina's + Bul-Kathos'{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 163: Cow King's Leathers Forsaken Pact
            code = "L29",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Artio's Calling {grey}({green}Berserker's + Cow King's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 164: Naj's Ancient Vestige Forsaken Pact
            code = "L30",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Elemental Blueprints {grey}({green}Iratha's + Arcanna's + Naj's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 165: Sander's Folly Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L31",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 166: Holy Vessel Forsaken Pact
            code = "L32",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Celestial Caress {grey}({green}Angelic + Disciple + Holy Vessel's{grey})\n{green}Breaker of Chains {grey}({green}Holy Vessel's + Majestic Lancer's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 167: Majestic Lancer Forsaken Pact
            code = "L33",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Breaker of Chains {grey}({green}Holy Vessel's + Majestic Lancer's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 168: Skovos Storm Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L34",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 169: Wonder Wear Forsaken Pact
            code = "L35",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Plates of Protection {grey}({green}Isenhart's + Sazabi's + Wonder Wear{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 170: Vizjerei Vocation Forsaken Pact
            code = "L36",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 171: Beyond Battlemage Forsaken Pact
            code = "L37",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 172: Glacial Plains Forsaken Pact
            code = "L38",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Black Tempest {grey}({green}Glacial Plains + Blessings of Artemis{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 173: Rathma's Calling Forsaken Pact
            code = "L39",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Mikael's Toxicity {grey}({green}Cleglaw's + Rathma's{grey})\n{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 174: Stacatomamba's Guidance Forsaken Pact
            code = "L40",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Mangala's Teachings {grey}({green}Hsarus' + Natalya's + Stacatomamba's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 175: Kreigur's Mastery Forsaken Pact
            code = "L41",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Silhouette of Silence {grey}({green}Natalya's + Kreigur's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 176: Scarlet Sukami Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L42",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 177: Mirrored Flames Forsaken Pact
            code = "L43",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Sacrificial Tribute {grey}({green}Tal Rasha's + Griswold's + Mirrored Flames{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 178: Unstoppable Force Forsaken Pact
            code = "L44",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Path of the Vortex (Barbarian) {grey}({green}Unstoppable Force + Natalya's{grey})\n{green}Path of the Vortex (Assassin) {grey}({green}Unstoppable Force + Natalya's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 179: Underworld's Unrest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L45",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 180: Elemental Blueprints Forsaken Pact
            code = "L46",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Cascading Caldera {grey}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 181: Raijin's Rebellion Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L47",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 182: Mikael's Toxicity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L48",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 183: Warrior's Wrath Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L49",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 184: Blessings of Artemis Forsaken Pact
            code = "L50",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Black Tempest {grey}({green}Glacial Plains + Blessings of Artemis{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 185: Artio's Calling Forsaken Pact
            code = "L51",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{green}Memento Mori {grey}({green}Rathma's + Artio's Calling + Death's{grey})\nUsed in {green}Forsaken Pacts{grey}:\n"
        },
        { -- Rule 186: Justitia's Divinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L52",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 187: Pulsing Presence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L53",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 188: Celestial Caress Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L54",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 189: Breaker of Chains Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L55",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 190: Silhouette of Silence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L56",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 191: Mangala's Teachings Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L57",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 192: Sacrificial Trinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L58",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 193: Plates of Protection Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L59",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        { -- Rule 194: Black Tempest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L60",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Not used in any {green}Forsaken Pacts{grey} currently\n"
        },
        ...
        -- | RARE ITEMS              |
        -- +-------------------------+
        { -- Rule 195: Small border on Rare Jewels
            code = "jew",
            quality = "6",
            border = { 255, 255, 100, 255, 1 }
        },
        { -- Rule 196: Hide all non-LB Rare Weapons, Armor, Jewelry, and Quiver items at Character Level 75+ (they are relatively useless)
        ...
        -- | UNIQUE ITEMS            |
        -- +-------------------------+
        { -- Rule 197: Notify and small border for all Normal Unique items
        ...
        { -- Rule 198: Notify and small border for all Exceptional Unique items
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std", "Ev00", "Ev01", "Ev02" },
            quality = "7",
            rarity = "1",
            notify = "Unique Drop ²{link}",
        ...
        { -- Rule 199: Notify and small border for all Elite Unique items
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std", "Ev00", "Ev01", "Ev02" },
            quality = "7",
            rarity = "2",
            notify = "Unique Drop ³{link}",
        ...
        { -- Rule 200: Correcting Unique Small Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 82,
        ...
        { -- Rule 201: Correcting Unique Medium Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 83,
        ...
        { -- Rule 202: Correcting Unique Grand Carm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 84,
        ...
        { -- Rule 203: Correcting Annihilus name color
            code = "cm1",
            quality = "7",
            index = 543,
            identified = true,
        ...
        { -- Rule 204: Correcting Cola Cube name color
            code = "cm1",
            quality = "7",
            index = 606,
            identified = true,
        ...
        { -- Rule 205: Correcting Gheed's Fortune name color
            code = "cm3",
            quality = "7",
            index = 542,
            identified = true,
        ...
        { -- Rule 206: Correcting Unholy Commander name color
            code = "cm3",
            quality = "7",
            index = 590,
            identified = true,
        ...
        { -- Rule 207: Correcting Kuroneko no Himitsu name color
            code = "cm3",
            quality = "7",
            index = 654,
            identified = true,
        ...
        { -- Rule 208: Correcting Blank Talent name color
            code = "cm3",
            quality = "7",
            index = 611,
            identified = true,
        ...
        -- | CRAFTED ITEMS           |
        -- +-------------------------+
        { -- Rule 209: Reminder to pick up Crafted items so they don't get left behind
            codes = "allitems",
            quality = "8",
        ...
        -- | TEMPERED ITEMS          |
        -- +-------------------------+
        { -- Rule 210: Reminder to pick up Tempered items so they don't get left behind
            codes = "allitems",
            quality = "9",
            notify = "{green}DON'T FORGET ME! {link}"
        },
        { -- Rule 211: Normal Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "0",
        ...
        { -- Rule 212: Exceptional Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "1",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 213: Elite Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "2",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 214: Misc Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            stat = { index = 402, op = "==", value = 0 },
        ...
        {-- Rule 215: Parts for Demon-Tempering
        ...
        -- | POTIONS & SCROLLS       |
        -- +-------------------------+
        { -- Rule 216: Hides all non-large Potions & Scrolls after Normal Difficulty
            codes = { "mp1", "mp2", "mp3", "hp1", "hp2", "hp3", "isc", "tsc", "rvs"},
            difficulty = "1+",
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
            hide = true
        },
        { -- Rule 217: Add helper text to Antidote Potion that it's used in Blood Contracts
            code = "yps",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Used for {green}Set {gray}Blood Contracts\n"
        },
        { -- Rule 218: Add helper text to Thawing Potion that it's used in Blood Contracts
            code = "wms",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Used for {gold}Unique {gray}Blood Contracts\n"
        },
        { -- Rule 219: Add helper text to Scroll of Identify for some cube recipes it's in
            code = "isc",
            location = { "onplayer", "atvendor" },
        ...
        -- | BASE ITEMS              |
        -- +-------------------------+
        { -- Rule 220: Reminder to pick up Runeword items so they don't get left behind
            codes = "allitems",
            runeword = true,
            notify = "{grey}DON'T FORGET ME! {gold}{link}",
            border = { 199, 179, 119, 255, 3 }
        },
        { -- Rule 221: Hiding Inferior items at Character Level 10+
            codes = NOT { "leg" },
            quality = "1",
            itype = { 45, 50 },
            runeword = false,
        ...
        { -- Rule 222: Hiding Normal items at Character Level 50+
            codes = NOT { "leg" },
            quality = "2",
            itype = { 45, 50 },
            runeword = false,
        ...
        { -- Rule 223: Hiding Normal quivers at Character Level 10+
            codes = { "aqv", "cqv" },
            quality = "3-",
            pstat = { index = 12, op = ">=", value = 10 },
            area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },
        ...
        { -- Rule 224: Hides all +0 to Paladin Skill Levels Scepters at Character Level 50+
        ...
        -- | ITEM HELPER TEXT        |
        -- +-------------------------+
        { -- Rule 225: Scroll of Inifuss
            code = "bks",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{grey}Talk to {white}Akara {grey}in Act 1\n\n"
        },
        { -- Rule 226: Scroll of Inifuss, deciphered
            code = "bkd",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 264: Amethyst Remover
            code = "Z02",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {purple}Caster {grey}crafting\n"
        },
        { -- Rule 265: Topaz Remover
            code = "Z03",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {yellow}Disarm {grey}crafting\n"
        },
        { -- Rule 266: Sapphire Remover
            code = "Z04",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {blue}Hit Power {grey}crafting\n"
        },
        { -- Rule 267: Emerald Remover
            code = "Z05",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {green}Safety {grey}crafting\n"
        },
        { -- Rule 268: Ruby Remover
            code = "Z06",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {red}Blood {grey}crafting\n"
        },
        { -- Rule 269: Diamond Remover
            code = "Z07",
            location = { "onplayer", "atvendor" },
            prefix = "{grey}Used in {white}Legion {grey}crafting\n{white}"
        },
        { -- Rule 270: Skull Remover
            code = "Z08",
            location = { "onplayer", "atvendor" },
        },
        { -- Rule 271: Adding Soul Shards helper text
            code = "S01",
            location = { "onplayer", "atvendor" },
            prefix_desc = "{tan}1-3 Soul Shards (used for Soul Summons)\n",
        },
        { -- Rule 272: Normal Unique Armor & Weapon upgrade recipe
        ...
        { -- Rule 273: Normal Rare Armor & Weapon upgrade recipe
            codes = "allitems",
            itype = { 45, 50 },
            quality = "6",
            rarity = "0",
        ...
        { -- Rule 274: Exceptional Unique Armor & Weapon upgrade recipe
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2", "std" },
            itype = { 45, 50 },
            quality = "7",
            rarity = "1",
        ...
        { -- Rule 275: Exceptional Rare Armor & Weapon upgrade recipe
            codes = "allitems",
            itype = { 45, 50 },
            quality = "6",
            rarity = "1",
        ...
        { -- Rule 277: Premium Socket Remover
            code = "b65",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 278: Infinite Socket Remover
            code = "b66",
            location = { "onplayer", "atvendor" },
            name_override = "{gold}Infinite Socket Remover",
        },
        { -- Rule 279: Rainbow Facets
            code = "jew",
            quality = "7",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 280: Color all class tokens
            codes = { "TK1", "TK2", "TK3", "TK4", "TK5", "TK6", "TK7" },
            location = { "onplayer", "atvendor", "onground" },
            prefix = "{purple}",
        },
        { -- Rule 281: Add info to Amazon Class Token
            code = "TK1",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 289: Low Enhancement Crystal renaming
        ...
        { -- Rule 298: On Ramaladni's Gift display the limits it has on Weapons
            code = "Rgx",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 299: Helper text for 0 socket items to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = "8-",
            maxsock = false,
            itype = { 10, 12, 50 },
        ...
        { -- Rule 300: Helper text for Magic/Rare/Crafted 0 socket Weapons to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = { "4", "6", "8" },
            maxsock = false,
            itype = 45,
        ...
        { -- Rule 301: Helper text for Set/Unique 1-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 302: Helper text for Set/Unique 2-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 303: Shows maximum sockets a non-Weapon item can get
        ...
        { -- Rule 304: Shows maximum sockets an Inferior/Normal/Magic/Rare/Crafted Weapon can get
            codes = "allitems",
            quality = { "1", "2", "3", "4", "6", "8" },
            itype = 45,
            location = { "onplayer", "atvendor", "equipped" },
        ...
        { -- Rule 305: Add helper text for Set/Unique Weapons that have a maximum of 2, 3, & 4 sockets
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2" },
            quality = { "5", "7" },
            maxsock = "4-",
            itype = 45,
        ...
        { -- Rule 306: Add helper text for 1-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
        ...
        { -- Rule 307: Add helper text for 2-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
            codes = { "lax", "bax", "btx", "gax", "gix", "mau", "gma", "clm", "gis", "bsw", "flb", "gsd", "spr", "tri", "brn", "spt", "pik", "bar", "vou", "scy", "pax", "hal", "wsc", "sst", "lst", "cst", "bst", "wst", "sbw", "hbw", "lbw", "cbw", "sbb", "lbb", "swb", "lwb", "lxb", "mxb", "hxb", "rxb", "9la", "9ba", "9bt", "9ga", "9gi", "9m9", "9gm", "9cm", "9gs", "9b9", "9fb", "9gd", "9sr", "9tr", "9br", "9st", "9p9", "9b7", "9vo", "9s8", "9pa", "9h9", "9wc", "8ss", "8ls", "8cs", "8bs", "8ws", "8sb", "8hb", "8lb", "8cb", "8s8", "8l8", "8sw", "8lw", "8lx", "8mx", "8hx", "8rx", "7la", "7ba", "7bt", "7ga", "7gi", "7m7", "7gm", "7cm", "7gs", "7b7", "7fb", "7gd", "7sr", "7tr", "7br", "7st", "7p7", "7o7", "7vo", "7s8", "7pa", "7h7", "7wc", "6ss", "6ls", "6cs", "6bs", "6ws", "6sb", "6hb", "6lb", "6cb", "6s7", "6l7", "6sw", "6lw", "6lx", "6mx", "6hx", "6rx", "am1", "am2", "am3", "am4", "am6", "am7", "am8", "am9", "amb", "amc", "amd", "ame", "Ds1", "Ds2", "Ds3", "Ds4", "Ds5", "Ds6", "Bm1", "Bm2", "Bm3", "Bm4", "Bm5", "Bm6", "Bm7", "Bm8", "Bm9", "l14", "l15", "l17", "l18" },
            quality = { "5", "7" },
            maxsock = "5+",
            itype = 45,
        ...
        { -- Rule 308: Special use-case for Rune Master (since it can get 5 sockets)
            code = "72a",
            quality = "7",
            index = 189,
            sockets = "4-",
        ...
        { -- Rule 309: Special use-case for Rune Master (since it can get 5 sockets)
            code = "72a",
            quality = "7",
            index = 189,
            sockets = "5",
        ...
        -- | TAGS & GENERIC RULES    |
        -- +-------------------------+
        { -- Rule 310: Adding item level to non-Ethereal non-socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
        ...
        { -- Rule 311: Adding item level to Ethereal items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = true,
            location = { "onplayer", "equipped" , "onground", "dropping", "atvendor" },
        ...
        { -- Rule 312: Adding item level to Non-Ethereal socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = false,
            sockets = "1+",
        ...
        { -- Rule 313: Color item name and add [Eth] tag to Inferior, Normal, and Superior items
            codes = "allitems",
            quality = "3-",
            ethereal = true,
            prefix = "ÿcI",
        ...
        { -- Rule 314: Do NOT color item name but still add [Eth] tag to Magic+ items
            codes = "allitems",
            quality = "4+",
            ethereal = true,
            suffix = "{grey}[Eth]"
        },
        { -- Rule 315: Adding socket number tag to 1 socket items
            codes = "allitems",
            sockets = "1",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 316: Adding socket number tag to 2 socket non-max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "3+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 317: Adding socket number tag to 2 socket max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "2",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 318: Adding socket number tag to 3 socket non-max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "4+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 319: Adding socket number tag to 3 socket max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "3",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 320: Adding socket number tag to 4 socket non-max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "5+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 321: Adding socket number tag to 4 socket max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "4",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 322: Adding socket number tag to 5 socket non-max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "6+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 323: Adding socket number tag to 5 socket max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "5",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 324: Adding socket number tag to 6 socket non-max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "7+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 325: Adding socket number tag to 6 socket max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "6",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 326: Adding socket number tag to 7 socket non-max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "8+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 327: Adding socket number tag to 7 socket max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "7",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 328: Adding socket number tag to 8 socket non-max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "9+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 329: Adding socket number tag to 8 socket max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "8",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 330: Adding socket number tag to 9 socket non-max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "10+",
            suffix = "{grey}[{sockets}]"
        },
        { -- Rule 331: Adding socket number tag to 9 socket max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "9",
            suffix = "{grey}[{green}{sockets}{grey}]"
        },
        { -- Rule 332: Adding superscript "1" in front of Normal tier items names
            codes = "allitems",
            rarity = "0",
            itype = { 45, 50 },
        ...
        { -- Rule 333: Adding superscript "2" in front of Exceptional tier items names
            codes = "allitems",
            rarity = "1",
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 334: Adding superscript "EB 3" in front of Elite tier items names
            codes = NOT { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 335: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior Ethereal Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = true,
            rarity = "2",
            quality = "3-",
        ...
        { -- Rule 336: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = false,
            sockets = "1+",
            rarity = "2",
        ...
        { -- Rule 337: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal non-socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            ethereal = false,
            sockets = "0",
            rarity = "2",
        ...
        { -- Rule 338: Adding colored superscript "LB 3" in front of Elite tier Magic Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "4",
            itype = { 45, 50 },
        ...
        { -- Rule 339: Adding colored superscript "LB 3" in front of Elite tier Set Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "5",
            itype = { 45, 50 },
        ...
        { -- Rule 340: Adding colored superscript "LB 3" in front of Elite tier Rare Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "6",
            itype = { 45, 50 },
        ...
        { -- Rule 341: Adding colored superscript "LB 3" in front of Elite tier Unique Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "7",
            itype = { 45, 50 },
        ...
        { -- Rule 342: Adding colored superscript "LB 3" in front of Elite tier Crafted Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "8",
            itype = { 45, 50 },
        ...
        { -- Rule 343: Adding colored superscript "LB 3" in front of Elite tier Demon Tempered Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            quality = "9",
            itype = { 45, 50 },
        ...
        { -- Rule 344: Notify for Elite tier Limit Break items
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17", "l18" },
            rarity = "2",
            itype = { 45, 50 },
        ...
        -- | TESTING                 |
        -- +-------------------------+
        -- { -- Rule 345: For testing, adds a bunch of info to item
        --     codes = "allitems",
        --     location = { "onplayer", "equipped", "onground", "dropping", "atvendor" },
