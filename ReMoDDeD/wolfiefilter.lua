--- Filter Title: WolfieeifloW's Filter v1.40
...
return {
    reload = "WolfieeifloW's Filter v1.40: {green}reloaded",
    allowOverrides = true,
    -- debug = true,
    rules = {
        -- +-------------------------+
        ...
        -- | MAGIC ITEMS             |
        -- +-------------------------+
        { -- Rule 101: Hide all non-RMD magic items at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        { -- Rule 102: Hide all magic Amulets, Rings, & Quivers at Character Level 75+ (Magic items can be gambled for crafting)
        ...
        -- | SET ITEMS               |
        -- +-------------------------+
        { -- Rule 103: Notify and small border for all Set items
            codes = "allitems",
            quality = "5",
            notify = "{green}Set Drop {link}",
            border = { 0, 206, 0, 255, 1 },
        },
        { -- Rule 104: Civerb's Vestments Set items
            codes = "allitems",
            quality = "5",
            index = { 0, 1, 2 },
            location = "onplayer",
        ...
        { -- Rule 105: Hsarus' Defense Set items
            codes = "allitems",
            quality = "5",
            index = { 3, 4, 5 },
            location = "onplayer",
        ...
        { -- Rule 106: Cleglaw's Brace Set items
            codes = "allitems",
            quality = "5",
            index = { 6, 7, 8 },
            location = "onplayer",
        ...
        { -- Rule 107: Iratha's Finery Set items
            codes = "allitems",
            quality = "5",
            index = { 9, 10, 11, 12 },
            location = "onplayer",
        ...
        { -- Rule 108: Isenhart's Armory Set items
            codes = "allitems",
            quality = "5",
            index = { 13, 14, 15, 16 },
            location = "onplayer",
        ...
        { -- Rule 109: Vidala's Rig Set items
            codes = "allitems",
            quality = "5",
            index = { 17, 18, 19, 20 },
            location = "onplayer",
        ...
        { -- Rule 110: Milabrega's Regalia Set items
            codes = "allitems",
            quality = "5",
            index = { 21, 22, 23, 24 },
            location = "onplayer",
        ...
        { -- Rule 111: Cathan's Traps Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 112: Tancred's Battlegear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 113: Sigon's Complete Steel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 114: Infernal Tools Set items
            codes = "allitems",
            quality = "5",
            index = { 41, 42, 43 },
            location = "onplayer",
        ...
        { -- Rule 115: Berserker's Arsenal Set items
            codes = "allitems",
            quality = "5",
            index = { 44, 45, 46 },
            location = "onplayer",
        ...
        { -- Rule 116: Death's Disguise Set items
            codes = "allitems",
            quality = "5",
            index = { 47, 48, 49 },
            location = "onplayer",
        ...
        { -- Rule 117: Angelic Raiment Set items
            codes = "allitems",
            quality = "5",
            index = { 50, 51, 52, 53 },
            location = "onplayer",
        ...
        -- },
        { -- Rule 118: Arcanna's Tricks Set items
            codes = "allitems",
            quality = "5",
            index = { 58, 59, 60, 61 },
            location = "onplayer",
        ...
        { -- Rule 119: Natalya's Odium Set items
            codes = "allitems",
            quality = "5",
            index = { 62, 63, 64, 65 },
            location = "onplayer",
        ...
        { -- Rule 120: Aldur's Watchtower Set items
            codes = "allitems",
            quality = "5",
            index = { 66, 67, 68, 69 },
            location = "onplayer",
        ...
        { -- Rule 121: Immortal King Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 122: Tal Rasha's Wrappings Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 123: Griswold's Legacy Set items
            codes = "allitems",
            quality = "5",
            index = { 81, 82, 83, 84 },
            location = "onplayer",
        ...
        { -- Rule 124: Trang-Oul's Avatar Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 125: M'avina's Battle Hymn Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 126: The Disciple Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 127: Heaven's Brethren Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 128: Orphan's Call Set items
            codes = "allitems",
            quality = "5",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 129: Sazabi's Grand Tribute Set items
            codes = "allitems",
            quality = "5",
            index = { 112, 113, 114 },
            location = "onplayer",
        ...
        { -- Rule 130: Bul-Kathos' Children Set items
            codes = "allitems",
            quality = "5",
            index = { 115, 116 },
            location = "onplayer",
        ...
        { -- Rule 131: Cow King's Leathers Set items
            codes = "allitems",
            quality = "5",
            index = { 117, 118, 119 },
            location = "onplayer",
        ...
        { -- Rule 132: Naj's Ancient Vestige Set items
            codes = "allitems",
            quality = "5",
            index = { 120, 121, 122 },
            location = "onplayer",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 133: Holy Vessel Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 134: Majestic Lancer Set items
            codes = "allitems",
            quality = "5",
            index = { 131, 132, 133 },
            location = "onplayer",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 135: Wonder Wear Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 136: Vizjerei Vocation Set items
            codes = "allitems",
            quality = "5",
            index = { 141, 142, 143 },
            location = "onplayer",
        ...
        { -- Rule 137: Beyond Battlemage Set items
            codes = "allitems",
            quality = "5",
            index = { 144, 145, 146 },
            location = "onplayer",
        ...
        { -- Rule 138: Glacial Plains Set items
            codes = "allitems",
            quality = "5",
            index = { 147, 148, 149 },
            location = "onplayer",
        ...
        { -- Rule 139: Rathma's Calling Set items
            codes = "allitems",
            quality = "5",
        ...
        { -- Rule 140: Stacatomamba's Guidance Set items
            codes = "allitems",
            quality = "5",
            index = { 154, 155 },
            location = "onplayer",
        ...
        { -- Rule 141: Kreigur's Mastery Set items
            codes = "allitems",
            quality = "5",
            index = { 156, 157 },
            location = "onplayer",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 142: Mirrored Flames Set items
            codes = "allitems",
            quality = "5",
            index = { 160, 161, 162 },
            location = "onplayer",
        ...
        { -- Rule 143: Unstoppable Force Set items
            codes = "allitems",
            quality = "5",
            index = { 163, 164 },
            location = "onplayer",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 144: Elemental Blueprints Set items
            codes = "allitems",
            quality = "5",
            index = { 168, 169, 170 },
            location = "onplayer",
        ...
        --     prefix_desc = "{green}xx\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        -- },
        { -- Rule 145: Blessings of Artemis Set items
            codes = "allitems",
            quality = "5",
            index = { 179, 180 },
            location = "onplayer",
        ...
        { -- Rule 146: Artio's Calling Set items
            codes = "allitems",
            quality = "5",
            index = { 181, 182, 183 },
            location = "onplayer",
        ...
        { -- Rule 159: Death's Disguise Forsaken Pact
            code = "L12",
            location = "onplayer",
            prefix_desc = "{green}Unstoppable Force {gray}({green}Bul-Kathos' + Berserker's + Death's{gray})\n{green}Memento Mori {gray}({green}Rathma's + Artio's Calling + Death's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 160: Angelic Raiment Forsaken Pact
            code = "L13",
            location = "onplayer",
        ...
        { -- Rule 161: Arctic Gear Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L14",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 162: Arcanna's Tricks Forsaken Pact
            code = "L15",
            location = "onplayer",
            prefix_desc = "{green}Elemental Blueprints {gray}({green}Iratha's + Arcanna's + Naj's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 163: Natalya's Odium Forsaken Pact
            code = "L16",
            location = "onplayer",
        ...
        { -- Rule 164: Aldur's Watchtower Forsaken Pact
            code = "L17",
            location = "onplayer",
            prefix_desc = "{green}Warrior's Wrath {gray}({green}Immortal King + Aldur's + Infernal{gray})\n{green}Mirrored Flames {gray}({green}Civerb's + Aldur's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 165: Immortal King Forsaken Pact
            code = "L18",
            location = "onplayer",
            prefix_desc = "{green}Blacklight (Paladin) {gray}({green}Sigon's + Immortal King{gray})\n{green}Blacklight (Barbarian) {gray}({green}Sigon's + Immortal King{gray})\n{green}Warrior's Wrath {gray}({green}Immortal King + Aldur's + Infernal{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 166: Tal Rasha's Wrappings Forsaken Pact
            code = "L19",
            location = "onplayer",
            prefix_desc = "{green}Sacrificial Tribute {gray}({green}Tal Rasha's + Griswold's + Mirrored Flames{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 167: Griswold's Legacy Forsaken Pact
            code = "L20",
            location = "onplayer",
            prefix_desc = "{green}Sacrificial Tribute {gray}({green}Tal Rasha's + Griswold's + Mirrored Flames{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 168: Trang-Oul's Avatar Forsaken Pact
            code = "L21",
            location = "onplayer",
            prefix_desc = "{green}Underworld Unrest {gray}({green}Trang-Oul's + Tancred's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 169: M'avina's Battle Hymn Forsaken Pact
            code = "L22",
            location = "onplayer",
            prefix_desc = "{green}Blessing of Artemis {gray}({green}Vidala's + M'avina's + Bul-Kathos'{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 170: The Disciple Forsaken Pact
            code = "L23",
            location = "onplayer",
            prefix_desc = "{green}Celestial Caress {gray}({green}Angelic + Disciple + Holy Vessel's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 171: Heaven's Brethren Forsaken Pact
            code = "L24",
            location = "onplayer",
            prefix_desc = "{green}Raijin's Rebellion {gray}({green}Milabrega's + Cathan's + Heaven's Brethren{gray})\n{green}Pulsing Presence {gray}({green}Sigon's + Angelic + Heaven's Brethren{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 172: Orphan's Call Forsaken Pact
            code = "L25",
            location = "onplayer",
            prefix_desc = "{green}Justitia's Divinity {gray}({green}Sigon's + Orphan's Call{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 173: Hwanin's Majesty Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L26",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 174: Sazabi's Grand Tribute Forsaken Pact
            code = "L27",
            location = "onplayer",
            prefix_desc = "{green}Plates of Protection {gray}({green}Isenhart's + Sazabi's + Wonder Wear{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 175: Bul-Kathos' Children Forsaken Pact
            code = "L28",
            location = "onplayer",
            prefix_desc = "{green}Unstoppable Force {gray}({green}Bul-Kathos' + Berserker's + Death's{gray})\n{green}Blessing of Artemis {gray}({green}Vidala's + M'avina's + Bul-Kathos'{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 176: Cow King's Leathers Forsaken Pact
            code = "L29",
            location = "onplayer",
            prefix_desc = "{green}Artio's Calling {gray}({green}Berserker's + Cow King's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 177: Naj's Ancient Vestige Forsaken Pact
            code = "L30",
            location = "onplayer",
            prefix_desc = "{green}Elemental Blueprints {gray}({green}Iratha's + Arcanna's + Naj's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 178: Sander's Folly Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L31",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 179: Holy Vessel Forsaken Pact
            code = "L32",
            location = "onplayer",
            prefix_desc = "{green}Celestial Caress {gray}({green}Angelic + Disciple + Holy Vessel's{gray})\n{green}Breaker of Chains {gray}({green}Holy Vessel's + Majestic Lancer's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 180: Majestic Lancer Forsaken Pact
            code = "L33",
            location = "onplayer",
            prefix_desc = "{green}Breaker of Chains {gray}({green}Holy Vessel's + Majestic Lancer's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 181: Skovos Storm Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L34",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 182: Wonder Wear Forsaken Pact
            code = "L35",
            location = "onplayer",
            prefix_desc = "{green}Plates of Protection {gray}({green}Isenhart's + Sazabi's + Wonder Wear{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 183: Vizjerei Vocation Forsaken Pact
            code = "L36",
            location = "onplayer",
            prefix_desc = "{green}Cascading Caldera {gray}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 184: Beyond Battlemage Forsaken Pact
            code = "L37",
            location = "onplayer",
            prefix_desc = "{green}Cascading Caldera {gray}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 185: Glacial Plains Forsaken Pact
            code = "L38",
            location = "onplayer",
            prefix_desc = "{green}Black Tempest {gray}({green}Glacial Plains + Blessings of Artemis{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 186: Rathma's Calling Forsaken Pact
            code = "L39",
            location = "onplayer",
            prefix_desc = "{green}Mikael's Toxicity {gray}({green}Cleglaw's + Rathma's{gray})\n{green}Memento Mori {gray}({green}Rathma's + Artio's Calling + Death's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 187: Stacatomamba's Guidance Forsaken Pact
            code = "L40",
            location = "onplayer",
            prefix_desc = "{green}Mangala's Teachings {gray}({green}Hsarus' + Natalya's + Stacatomamba's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 188: Kreigur's Mastery Forsaken Pact
            code = "L41",
            location = "onplayer",
            prefix_desc = "{green}Silhouette of Silence {gray}({green}Natalya's + Kreigur's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 189: Scarlet Sukami Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L42",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 190: Mirrored Flames Forsaken Pact
            code = "L43",
            location = "onplayer",
            prefix_desc = "{green}Sacrificial Tribute {gray}({green}Tal Rasha's + Griswold's + Mirrored Flames{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 191: Unstoppable Force Forsaken Pact
            code = "L44",
            location = "onplayer",
            prefix_desc = "{green}Path of the Vortex (Barbarian) {gray}({green}Unstoppable Force + Natalya's{gray})\n{green}Path of the Vortex (Assassin) {gray}({green}Unstoppable Force + Natalya's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 192: Underworld's Unrest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L45",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 193: Elemental Blueprints Forsaken Pact
            code = "L46",
            location = "onplayer",
            prefix_desc = "{green}Cascading Caldera {gray}({green}Elemental Blueprints + Vizjerei + Beyond Battlemage{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 194: Raijin's Rebellion Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L47",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 195: Mikael's Toxicity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L48",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 196: Warrior's Wrath Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L49",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 197: Blessings of Artemis Forsaken Pact
            code = "L50",
            location = "onplayer",
            prefix_desc = "{green}Black Tempest {gray}({green}Glacial Plains + Blessings of Artemis{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 198: Artio's Calling Forsaken Pact
            code = "L51",
            location = "onplayer",
            prefix_desc = "{green}Memento Mori {gray}({green}Rathma's + Artio's Calling + Death's{gray})\n{gold}Used in {green}Forsaken Pacts{gold}:\n"
        },
        { -- Rule 199: Justitia's Divinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L52",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 200: Pulsing Presence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L53",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 201: Celestial Caress Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L54",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 202: Breaker of Chains Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L55",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 203: Silhouette of Silence Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L56",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 204: Mangala's Teachings Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L57",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 205: Sacrificial Trinity Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L58",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 206: Plates of Protection Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L59",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        { -- Rule 207: Black Tempest Forsaken Pact (not currently used in any Forsaken Forsaken Pacts)
            code = "L60",
            location = "onplayer",
            prefix_desc = "{gold}Not used in any {green}Forsaken Pacts{gold} currently\n"
        },
        ...
        -- | RARE ITEMS              |
        -- +-------------------------+
        { -- Rule 208: Small border on Rare Amulets, Rings, and Jewels
            codes = { "amu", "rin", "jew" },
            quality = "6",
        ...
        -- | UNIQUE ITEMS            |
        -- +-------------------------+
        { -- Rule 209: Notify and small border for all Unique items
        ...
        { -- Rule 210: Correcting Unique Small Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 82,
        ...
        { -- Rule 211: Correcting Unique Medium Charm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 83,
        ...
        { -- Rule 212: Correcting Unique Grand Carm color on ground
            codes = "allitems",
            quality = "7",
            identified = false,
            itype = 84,
        ...
        { -- Rule 213: Correcting Gheed's Fortune name color
            code = "cm3",
            quality = "7",
            index = 542,
            identified = true,
        ...
        { -- Rule 214: Correcting Unholy Commander name color
            code = "cm3",
            quality = "7",
            index = 590,
            identified = true,
        ...
        { -- Rule 215: Correcting Kuroneko no Himitsu name color
            code = "cm3",
            quality = "7",
            index = 654,
            identified = true,
        ...
        -- | CRAFTED ITEMS           |
        -- +-------------------------+
        { -- Rule 216: Reminder to pick up Crafted items so they don't get left behind
            codes = "allitems",
            quality = "8",
        ...
        -- | TEMPERED ITEMS          |
        -- +-------------------------+
        { -- Rule 217: Reminder to pick up Tempered items so they don't get left behind
            codes = "allitems",
            quality = "9",
            notify = "{green}DON'T FORGET ME! {link}"
        },
        { -- Rule 218: Normal Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "0",
        ...
        { -- Rule 219: Exceptional Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "1",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 220: Elite Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            rarity = "2",
            stat = { index = 402, op = "==", value = 0 },
        ...
        { -- Rule 221: Misc Uniques that can be Demon-Tempered
            codes = "allitems",
            quality = "7",
            stat = { index = 402, op = "==", value = 0 },
        ...
        {-- Rule 222: Parts for Demon-Tempering
        ...
        -- | POTIONS                 |
        -- +-------------------------+
        { -- Rule 223: Hides all non-large Potions & Scrolls after Normal Difficulty
        ...
        { -- Rule 283: Enhancement Crystals warning their only usable on Weapons/Armors
        ...
        { -- Rule 284: Display cube recipes on Gold Bar that relate to it
            code = "Y21",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 285: On Ramaladni's Gift display the limits it has on Weapons
            code = "Rgx",
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 286: Helper text for 0 socket items to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = "8-",
            maxsock = false,
            itype = { 10, 12, 50 },
        ...
        { -- Rule 287: Helper text for Magic/Rare/Crafted 0 socket Weapons to use Ramaladni's Gift to add sockets
            codes = "allitems",
            quality = { "4", "6", "8" },
            maxsock = false,
            itype = 45,
        ...
        { -- Rule 288: Helper text for Set/Unique 1-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 289: Helper text for Set/Unique 2-Hand 0 socket Weapons to use Ramaladni's Gift to add sockets
        ...
        { -- Rule 290: Shows maximum sockets a non-Weapon item can get
        ...
        { -- Rule 291: Shows maximum sockets an Inferior/Normal/Magic/Rare/Crafted Weapon can get
            codes = "allitems",
            quality = { "1", "2", "3", "4", "6", "8" },
            itype = 45,
            location = { "onplayer", "atvendor" },
        ...
        { -- Rule 292: Add helper text for Set/Unique Weapons that have a maximum of 2, 3, & 4 sockets
            codes = NOT { "bks", "bkd", "leg", "hdm", "ass", "hst", "vip", "msf", "j34", "g34", "xyz", "g33", "qey", "qbr", "qhr", "qf1", "qf2", "bbb", "mss", "hfh", "ice", "tr2" },
            quality = { "5", "7" },
            maxsock = "4-",
            itype = 45,
        ...
        { -- Rule 293: Add helper text for 1-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
        ...
        { -- Rule 294: Add helper text for 2-Hand Set/Unique Weapons that have a maximum of 5 & 6 sockets
            codes = { "lax", "bax", "btx", "gax", "gix", "mau", "gma", "clm", "gis", "bsw", "flb", "gsd", "spr", "tri", "brn", "spt", "pik", "bar", "vou", "scy", "pax", "hal", "wsc", "sst", "lst", "cst", "bst", "wst", "sbw", "hbw", "lbw", "cbw", "sbb", "lbb", "swb", "lwb", "lxb", "mxb", "hxb", "rxb", "9la", "9ba", "9bt", "9ga", "9gi", "9m9", "9gm", "9cm", "9gs", "9b9", "9fb", "9gd", "9sr", "9tr", "9br", "9st", "9p9", "9b7", "9vo", "9s8", "9pa", "9h9", "9wc", "8ss", "8ls", "8cs", "8bs", "8ws", "8sb", "8hb", "8lb", "8cb", "8s8", "8l8", "8sw", "8lw", "8lx", "8mx", "8hx", "8rx", "7la", "7ba", "7bt", "7ga", "7gi", "7m7", "7gm", "7cm", "7gs", "7b7", "7fb", "7gd", "7sr", "7tr", "7br", "7st", "7p7", "7o7", "7vo", "7s8", "7pa", "7h7", "7wc", "6ss", "6ls", "6cs", "6bs", "6ws", "6sb", "6hb", "6lb", "6cb", "6s7", "6l7", "6sw", "6lw", "6lx", "6mx", "6hx", "6rx", "am1", "am2", "am3", "am4", "am6", "am7", "am8", "am9", "amb", "amc", "amd", "ame", "Ds1", "Ds2", "Ds3", "Ds4", "Ds5", "Ds6", "Bm1", "Bm2", "Bm3", "Bm4", "Bm5", "Bm6", "Bm7", "Bm8", "Bm9", "l14", "l15", "l17" },
            quality = { "5", "7" },
            maxsock = "5+",
            itype = 45,
        ...
        -- | TAGS & GENERIC RULES    |
        -- +-------------------------+
        { -- Rule 297: Adding item level to non-Ethereal non-socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
        ...
        { -- Rule 298: Adding item level to Ethereal items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = true,
            location = { "onplayer", "equipped" , "onground", "dropping", "atvendor" },
        ...
        { -- Rule 299: Adding item level to Non-Ethereal socketed items (Rings, Amulets, Weapons, Armors, Jewels, and Small/Large/Grand Charms)
            codes = "allitems",
            itype = { 10, 12, 45, 50, 58, 82, 83, 84 },
            ethereal = false,
            sockets = "1+",
        ...
        { -- Rule 300: Color item name and add [Eth] tag to Inferior, Normal, and Superior items
            codes = "allitems",
            quality = "3-",
            ethereal = true,
            prefix = "ÿcI",
        ...
        { -- Rule 301: Do NOT color item name but still add [Eth] tag to Magic+ items
            codes = "allitems",
            quality = "4+",
            ethereal = true,
            suffix = "{gray}[Eth]"
        },
        { -- Rule 302: Adding socket number tag to 1 socket items
            codes = "allitems",
            sockets = "1",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 303: Adding socket number tag to 2 socket non-max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "3+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 304: Adding socket number tag to 2 socket max sockets items
            codes = "allitems",
            sockets = "2",
            maxsock = "2",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 305: Adding socket number tag to 3 socket non-max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "4+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 306: Adding socket number tag to 3 socket max sockets items
            codes = "allitems",
            sockets = "3",
            maxsock = "3",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 307: Adding socket number tag to 4 socket non-max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "5+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 308: Adding socket number tag to 4 socket max sockets items
            codes = "allitems",
            sockets = "4",
            maxsock = "4",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 309: Adding socket number tag to 5 socket non-max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "6+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 310: Adding socket number tag to 5 socket max sockets items
            codes = "allitems",
            sockets = "5",
            maxsock = "5",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 311: Adding socket number tag to 6 socket non-max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "7+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 312: Adding socket number tag to 6 socket max sockets items
            codes = "allitems",
            sockets = "6",
            maxsock = "6",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 313: Adding socket number tag to 7 socket non-max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "8+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 314: Adding socket number tag to 7 socket max sockets items
            codes = "allitems",
            sockets = "7",
            maxsock = "7",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 315: Adding socket number tag to 8 socket non-max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "9+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 316: Adding socket number tag to 8 socket max sockets items
            codes = "allitems",
            sockets = "8",
            maxsock = "8",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 317: Adding socket number tag to 9 socket non-max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "10+",
            suffix = "{gray}[{sockets}]"
        },
        { -- Rule 318: Adding socket number tag to 9 socket max sockets items
            codes = "allitems",
            sockets = "9",
            maxsock = "9",
            suffix = "{gray}[{green}{sockets}{gray}]"
        },
        { -- Rule 319: Adding superscript "1" in front of Normal tier items names
            codes = "allitems",
            rarity = 0,
            itype = { 45, 50 },
        ...
        { -- Rule 320: Adding superscript "2" in front of Exceptional tier items names
            codes = "allitems",
            rarity = 1,
            itype = { 45, 50 },
            location = { "onground", "onplayer", "equipped", "atvendor" },
        ...
        { -- Rule 321: Adding superscript "EB 3" in front of Elite tier items names
        ...
        { -- Rule 322: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior Ethereal Limit Break items names
        ...
        { -- Rule 323: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            ethereal = false,
            sockets = "1+",
            rarity = 2,
        ...
        { -- Rule 324: Adding colored superscript "LB 3" in front of Elite tier Inferior/Normal/Superior non-Ethereal non-socketed Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            ethereal = false,
            sockets = "0",
            rarity = 2,
        ...
        { -- Rule 325: Adding colored superscript "LB 3" in front of Elite tier Magic Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "4",
            itype = { 45, 50 },
        ...
        { -- Rule 326: Adding colored superscript "LB 3" in front of Elite tier Set Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "5",
            itype = { 45, 50 },
        ...
        { -- Rule 327: Adding colored superscript "LB 3" in front of Elite tier Rare Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "6",
            itype = { 45, 50 },
        ...
        { -- Rule 328: Adding colored superscript "LB 3" in front of Elite tier Unique Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "7",
            itype = { 45, 50 },
        ...
        { -- Rule 329: Adding colored superscript "LB 3" in front of Elite tier Crafted Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "8",
            itype = { 45, 50 },
        ...
        { -- Rule 330: Adding colored superscript "LB 3" in front of Elite tier Demon Tempered Limit Break items names
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            quality = "9",
            itype = { 45, 50 },
        ...
        { -- Rule 331: Notify for Elite tier Limit Break items
            codes = { "l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14","l15", "l16", "l17" },
            rarity = 2,
            itype = { 45, 50 },
        ...
        -- | TESTING                 |
        -- +-------------------------+
        -- { -- Rule 332: For testing, adds a bunch of info to item
        --     codes = "allitems",
        --     location = { "onplayer", "equipped", "onground", "dropping", "atvendor" },
