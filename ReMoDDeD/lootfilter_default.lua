...
--- Filter Type: (Basic)
--- Filter Description: This is a barebones UwU filter that adds only the frequently requested modifications; such as item levels, socket counts, etc.
