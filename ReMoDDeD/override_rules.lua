...
-- region String Offloads
        ...
        { --Empty Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube this with a color dyed item to remove the color (dye not returned){gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
                jaJP = "{white}(染料を除去するための色の染色アイテムのあるキューブ{gold}\n",
                koKR = "{white}(염료를 제거하기 위해 색상 염색 품목이있는 큐브){gold}\n",
                plPL = "{white}(kostka z kolorowym elementem barwionym do usuwania barwnika){gold}\n",
                ptBR = "{white}(cubo com um item tingido de cor para remover o corante){gold}\n",
                ruRU = "{white}(куб с окрашенным цветом элемента для удаления красителя){gold}\n",
                zhCN = "{white}（带有颜色染色物品的立方体以去除染料）{gold}\n",
                zhTW = "{white}（帶有顏色染色物品的立方體以去除染料）{gold}\n",
            }
        },
        { --Bright White Bottle
            code = "Z53",
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{white} White\n{tan}or{white}\nCube with item to dye it\n\n{white}Bright White{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Black Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{gray} Light Grey\n{tan}or{white}\nCube with item to dye it\n\n{gray}Black{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Blue Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{blue} Light Blue\n{tan}or{white}\nCube with item to dye it\n\n{blue}Crystal Blue{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Red Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{red} Light Red\n{tan}or{white}\nCube with item to dye it\n\n{red}Crystal Red{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Green Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{green} Light Green\n{tan}or{white}\nCube with item to dye it\n\n{green}Crystal Green{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Yellow Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{yellow} Dark Yellow\n{tan}or{white}\nCube with item to dye it\n\n{yellow}Light Yellow{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Purple Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{purple} Dark Purple\n{tan}or{white}\nCube with item to dye it\n\n{purple}Light Purple{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --White Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{white} Bright White\n{tan}or{white}\nCube with item to dye it\n\n{white}White{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Grey Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{gray} Dark Grey\n{tan}or{white}\nCube with item to dye it\n\n{gray}Light Grey{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Grey Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{gray} Black\n{tan}or{white}\nCube with item to dye it\n\n{gray}Dark Grey{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Blue Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{blue} Dark Blue\n{tan}or{white}\nCube with item to dye it\n\n{blue}Light Blue{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Blue Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{blue} Crystal Blue\n{tan}or{white}\nCube with item to dye it\n\n{blue}Dark Blue{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Red Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{red} Dark Red\n{tan}or{white}\nCube with item to dye it\n\n{red}Light Red{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Red Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{red} Crystal Red\n{tan}or{white}\nCube with item to dye it\n\n{red}Dark Red{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Green Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{green} Dark Green\n{tan}or{white}\nCube with item to dye it\n\n{green}Light Green{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Green Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{green} Crystal Green\n{tan}or{white}\nCube with item to dye it\n\n{green}Dark Green{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Yellow Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{yellow} Light Yellow\n{tan}or{white}\nCube with item to dye it\n\n{yellow}Dark Yellow{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Purple Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{purple} Light Purple\n{tan}or{white}\nCube with item to dye it\n\n{purple}Dark Purple{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Orange Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{gold} Light Gold\n{tan}or{white}\nCube with item to dye it\n\n{orange}Orange{gold}\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Gold Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{gold} Dark Gold\n{tan}or{white}\nCube with item to dye it\n\n{gold}Light Gold\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Gold Bottle
            ...
            prefix = {
                deDE = "{white}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{white}Cube alone to change shade to{orange} Orange\n{tan}or{white}\nCube with item to dye it\n\n{gold}Dark Gold\n",
                esES = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{white}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{white}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{white}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --UpConverter (Basic)
            ...
            suffix = " {white}(Basic)",
            prefix = {
                deDE = "{white}Ermöglicht die Herstellung von 1{yellow} seltenem{white} Juwel, indem du 10 verpackte{blue} magische{white} Juwelen opferst\n\n",
                enUS = "{white}Allows you to create 1{yellow} rare{white} jewel by sacrificing 10 bagged{blue} magic{white} jewels\n\n",
                esES = "{white}le permite crear 1{yellow} rara{white} joya sacrificando 10 bolsas{blue} magia{white} joyas\n\n",
                esMX = "{white}le permite crear 1{yellow} rara{white} joya sacrificando 10 bolsas{blue} magia{white} joyas\n\n",
                frFR = "{white}Ti permette di creare 1 gioiello{yellow} raro{white} sacrificando 10 gioielli{blue} magici{white} insaccati\n\n",
                itIT = "{white}Vous permet de créer 1 joyau{yellow} rare{white} en sacrifiant 10 joyaux magiques{blue} en sac {white}\n\n",
                jaJP = "{white}では、10の袋を犠牲にすることにより、1{yellow} Rare{white} Jewelを作成できます{blue} Magic{white} Jewels\n\n",
                koKR = "{white}가방에 담긴{yellow} 마법{white} 보석 10개를 희생하여 1{gold} 희귀{white} 보석을 만들 수 있습니다\n\n",
                plPL = "{white}pozwala utworzyć 1{yellow} rzadki klejnot {white}, poświęcając 10 workowane{blue} magia{white} klejnoty\n\n",
                ptBR = "{white}permite criar 1{yellow} raro{white} jóia sacrificando 10 ensacado{blue} mágica{white} jóias\n\n",
                ruRU = "{white}позволяет создавать 1{yellow} red{white} jewel, жертвуя 10 мешками{blue} Magic{white} Jewels\n\n",
                zhCN = "{white}允许您通过牺牲 10 颗袋装{blue}魔法{white}宝石来创造 1{yellow}稀有{white}宝石\n\n",
                zhTW = "{white}允許您通過犧牲 10 顆袋裝{blue}魔法{white}寶石來創造 1{yellow}稀有{white}寶石\n\n"
            },
        },
