...
-- region String Offloads
        ...
        },
        {
            ...
            location = { "onplayer", "atvendor" },
            prefix = {
                deDE = "{Blue} 30 Level -Anforderung \n 2 bis kalte Fähigkeiten \n {lila} für Schmiede (keine Verwendungsgrenze): \n \n {blau} 25 Level -Anforderung \n 2 zu kalten Fähigkeiten \n",
                enUS = "{blue}+30 Level Requirement\n+2 to Cold Skills\n{purple}For Blacksmiths (No Usage Limit):\n\n{blue}+25 Level Requirement\n+2 to Cold Skills\n",
                esES = "{azul} 30 requisito de nivel \n 2 a las habilidades frías \n {púrpura} para herreros (sin límite de uso): \n \n {azul} 25 requisito de nivel \n 2 a habilidades frías \n",
                esMX = "{azul} 30 requisito de nivel \n 2 a las habilidades frías \n {púrpura} para herreros (sin límite de uso): \n \n {azul} 25 requisito de nivel \n 2 a habilidades frías \n",
                frFR = "{bleu} 30 Niveau exigence \n 2 to Cold Skills \n {violet} pour les forgerons (pas de limite d'utilisation): \n \n {bleu} 25 Niveau exigence",
                itIT = "{blu} 30 Livello Requisito \n 2 to Cold Skills \n {Purple} per i fabbri (nessun limite di utilizzo): \n \n {blu} 25 Livello Requisito \n 2 a Cold Skills \n",
                jaJP = "{blue} 30レベル要件\n 2へのコールドスキル\n {紫色}鍛冶屋の場合（使用制限なし）：\n \n {blue} 25レベル要件\n 2からコールドスキル\n",
                koKR = "{blue} 30 레벨 요구 사항 \n 2 대 콜드 스킬 \n {보라색} 대장장이 (사용법 제한 없음) : \n \n {blue} 25 레벨 요구 사항 \n 콜드 기술 \n",
                plPL = "{Blue} 30 Wymaganie poziomu \n 2 do zimnych umiejętności \n {fiolet} dla kowal (brak limitu użytkowania): \n \n {Blue} 25 Wymagania poziomu \n 2 do zimnego umiejętności \n",
                ptBR = "{azul} 30 Requisito de nível \n 2 para habilidades de frio \n {roxo} para ferreiros (sem limite de uso): \n \n {azul} 25 requisito de nível \n 2 para habilidades de frio \n n",
        ...
        { --Bright White Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {white}White{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{white}Bright White{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Black Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {grey}Light Grey{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{grey}Black{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Blue Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {blue}Light Blue{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{blue}Crystal Blue{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Red Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {red}Light Red{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{red}Crystal Red{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Crystal Green Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {green}Light Green{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{green}Crystal Green{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Yellow Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {yellow}Dark Yellow{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{yellow}Light Yellow{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Purple Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {purple}Dark Purple{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{purple}Light Purple{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --White Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {white}Bright White{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{white}White{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Grey Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {grey}Dark Grey{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{grey}Light Grey{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Grey Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {grey}Black{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{grey}Dark Grey{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Blue Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {blue}Dark Blue{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{blue}Light Blue{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Blue Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {blue}Crystal Blue{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{blue}Dark Blue{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Red Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {red}Dark Red{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{red}Light Red{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Red Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {red}Crystal Red{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{red}Dark Red{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Green Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {green}Dark Green{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{green}Light Green{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Green Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {green}Crystal Green{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{green}Dark Green{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Yellow Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {yellow}Light Yellow{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{yellow}Dark Yellow{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Purple Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {purple}Light Purple{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{purple}Dark Purple{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Orange Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {gold}Light Gold{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{orange}Orange{gold}\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Light Gold Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {gold}Dark Gold{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{gold}Light Gold\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Dark Gold Bottle
            ...
            prefix = {
                deDE = "{green}(Würfel mit einem farbigen Element zum Entfernen des Farbstoffs){gold}\n",
                enUS = "{lilac}Cube alone to change shade to {orange}Orange{lilac}\n{tan}or{lilac}\nCube with item to dye it\n\n{gold}Dark Gold\n",
                esES = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                esMX = "{green}(cubo con un elemento teñido de color para eliminar el tinte){gold}\n",
                frFR = "{green}(cube avec un élément teint en couleur pour supprimer le colorant){gold}\n",
                itIT = "{green}(Cube seul pour recevoir des récompenses)\n\n{gold}-Porte-clés sans fin\n{gold}-Livre de perspicacité\n{gold}-Livre de retour en toute sécurité\n{tan}Contient:\n\n",
        ...
        { --Jewel Converter (Magic -> Rare)
            ...
            location = { "onplayer", "equipped", "atvendor" },
            prefix = {
                deDE = "{Gray} 10 {blau} magische Juwelen {Gray} bis 1 {gelb} seltenes Juwel \n {Gray} Würfel mit Ihrem {Gold} -Deichentasche {Gray}, um \n \n zu konvertieren, \n \n",
                enUS = "{grey}10 {blue}Magic Jewels{grey} to 1 {yellow}Rare Jewel\n{grey}Cube with your {gold}Storage Bag{grey} to convert\n\n",
                esES = "{gris} 10 {azul} joyas mágicas {gris} a 1 {amarillo} joya rara \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                esMX = "{gris} 10 {azul} joyas mágicas {gris} a 1 {amarillo} joya rara \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                frFR = "{gris} 10 {bleu} bijoux magique {gris} à 1 {jaune} bijou rare \n {gris} Cube avec votre {or} sac de rangement {gris} pour convertir \n \n",
                itIT = "{grigio} 10 {blu} gioielli magici {grigio} a 1 {giallo} raro gioiello \n {grigio} cube",
                jaJP = "{灰色} 10 {青}魔法の宝石{グレー}から1 {黄色}レアジュエル\n {グレー}キューブ{ゴールド}ストレージバッグ{グレー} \n \nを変換する",
                koKR = "{Grey} 10 {Blue} Magic Jewels {Grey} to 1 {yellow} 희귀 보석 \n {Grey} {Gold} 스토리지 백 {Grey}가있는 큐브 {Grey} \n \n을 변환합니다.",
                plPL = "{Gray} 10 {Blue} Magic Jewels {Gray} do 1 {żółty} rzadki klejnot \n {Gray} Cube z {złotą} torbę do przechowywania {Gray}, aby przekonwertować \n \n",
                ptBR = "{Gray} 10 {azul} jóias mágicas {Gray} a 1 {amarelo} jóia rara \n {Gray} cubo com seu saco {Gold} de armazenamento {cinza} para converter \n \n n",
                ruRU = "{grey} 10 {blue} Magic Jewels {grey} до 1 {joll} редкая драгоценности \n {grey} куб с вашим {золотым} сумкой для хранения {grey}, чтобы преобразовать \n \n",
                zhCN = "{灰色} 10 {blue}魔术珠宝{灰色}至1 {yellow}稀有珠宝\n {灰色} cube带有{gold}储物袋{灰色} convert \n \n",
                zhTW = "{灰色} 10 {blue}魔術珠寶{灰色}至1 {yellow}稀有珠寶\n {灰色} cube帶有{gold}儲物袋{灰色} convert \n \n",
            },
        },
        { ---Jewel Converter (Rare -> Magic)
            ...
            location = { "onplayer", "equipped", "atvendor" },
            prefix = {
                deDE = "{grau} 1 {gelb} seltenes Juwel {grau} bis 10 {blau} magische Juwelen \n {Gray} Würfel mit deinem {Gold} -Deichentasche {Gray}, um \n \n zu konvertieren, \n \n",
                enUS = "{grey}1 {yellow}Rare Jewel{grey} to 10 {blue}Magic Jewels\n{grey}Cube with your {gold}Storage Bag{grey} to convert\n\n",
                esES = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                esMX = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                frFR = "{gris} 1 {jaune} joyau rare {gris} à 10 {bleu} bijoux magique \n {gris} cube avec votre {or} sac de rangement {gris} pour convertir \n \n",
                itIT = "{grigio} 1 {giallo} raro gioiello {grigio} a 10 {blu} gioielli magici \n {grigio} cube",
                jaJP = "{灰色} 1 {黄}レアジュエル{グレー}から10 {青}マジックジュエル\n {グレー}キューブ{ゴールド}ストレージバッグ{グレー} \n \nを変換する",
                koKR = "{grey} 1 {옐로우} 희귀 보석 {그레이} ~ 10 {blue} 마술 보석 \n {grey} {gold} 스토리지 백 {grey}가있는 큐브 {grey} \n \n을 변환합니다.",
                plPL = "{Gray} 1 {żółty} rzadki klejnot {Gray} do 10 {blue} magiczne klejnoty \n {Gray} Cube z {złotą} torbę do przechowywania {Gray} do konwersji \n \n",
                ...
                ruRU = "{grey} 1 {joll} редкая драгоценности {grey} до 10 {blue} Magic Jewels \n {grey} куб с вашим {золотым} сумкой для хранения {grey}, чтобы преобразовать \n \n",
                zhCN = "{灰色} 1 {yellow}稀有珠宝{灰色}至10 {blue}魔术珠宝\n {灰色} cube带有您的{Gold}储物袋{灰色}以转换\n \n",
                zhTW = "{灰色} 1 {yellow}稀有珠寶{灰色}至10 {blue}魔術珠寶\n {灰色} cube帶有您的{Gold}儲物袋{灰色}以轉換\n \n",
            },
        },
        { ---UpConverter (Basic)
            code = "u00",
        ...
        { ---UpConverter (Advanced)
            ...
            prefix = {
                deDE = "{grau} 1 {gelb} seltenes Juwel {grau} bis 10 {blau} magische Juwelen \n {Gray} Würfel mit deinem {Gold} -Deichentasche {Gray}, um \n \n zu konvertieren, \n \n",
                enUS = "Allows you to create 1 {gold}Rainbow Facet (random){white} by sacrificing 30 bagged {yellow}rare {white}jewels\n{tan}or\n{white}Allows you to convert a {lilac}Normal {white}Quality item into an {lilac}Exceptional {white}Quality item\n\n",
                esES = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                esMX = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                frFR = "{gris} 1 {jaune} joyau rare {gris} à 10 {bleu} bijoux magique \n {gris} cube avec votre {or} sac de rangement {gris} pour convertir \n \n",
                itIT = "{grigio} 1 {giallo} raro gioiello {grigio} a 10 {blu} gioielli magici \n {grigio} cube",
        ...
        { ---UpConverter (Elite)
            ...
            prefix = {
                deDE = "{grau} 1 {gelb} seltenes Juwel {grau} bis 10 {blau} magische Juwelen \n {Gray} Würfel mit deinem {Gold} -Deichentasche {Gray}, um \n \n zu konvertieren, \n \n",
                enUS = "Allows you to convert an {lilac}Exceptional {white}Quality item into an {lilac}Elite {white}Quality item\n\n",
                esES = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                esMX = "{gris} 1 {amarillo} joya rara {gris} a 10 {azul} joyas mágicas \n {gris} cubo con su {oro} bolsa de almacenamiento {gris} para convertir \n \n",
                frFR = "{gris} 1 {jaune} joyau rare {gris} à 10 {bleu} bijoux magique \n {gris} cube avec votre {or} sac de rangement {gris} pour convertir \n \n",
                itIT = "{grigio} 1 {giallo} raro gioiello {grigio} a 10 {blu} gioielli magici \n {grigio} cube",
