  ...
  --Rules Debugg.
    {
      ...
      --prefix = "S21={stat=(52)}|S22={stat=(53)}|S23={stat=(48)}|S24={stat=(49)}|",
      --prefix = "[{index}]",
      --prefix = "[{code}]",
